...
#data = {'myInt': 10, 'myLong': 3, 'myBool': True, 'myDouble': 2.71, 'myFloat': 0.01590000092983246, 'myBytes': b'\x11\x12\x13\x14\x15\x16\x17\x18', 'myString': 'this is a 2nd SimpleClass', 'myArray': [11,12,13,14,15,16,17,18], 'myMap': {'def': '999'}}
