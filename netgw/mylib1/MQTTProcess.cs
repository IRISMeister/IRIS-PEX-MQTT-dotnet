    ...
    public class MQTTProcess : InterSystems.EnsLib.PEX.BusinessProcess {
        ...
        public override object OnRequest(object request)  {
            ...
            foreach (dc.SimpleClass simple in items)
            {
                ...
                newrequest = (IRISObject)iris.ClassMethodObject("MQTT.SimpleClass", "%New", topic,seqno,simple.myInt,simple.myLong,simple.myBool,simple.myDouble,simple.myFloat,simple.myBytes,simple.myString,"["+String.Join(",",simple.myArray)+"]");
